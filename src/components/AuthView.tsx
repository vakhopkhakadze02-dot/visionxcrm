          ...
          >
            ...
            <div className="space-y-4">
              <div>
                ...
                <p>ჩაწერეთ შემდეგი ცვლადები თქვენი გარემოს ცვლადებში (.env ფაილი ან hosting პლატფორმის Environment Variables/Secrets მენიუ):</p>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-amber-500/10 border border-amber-500/25 rounded-2xl text-xs space-y-2 text-amber-400">
                ...
                <p className="leading-relaxed text-slate-300">
                  სრული ღრუბლოვანი სინქრონიზაციისთვის და იზოლირებული ანგარიშების გამოსაყენებლად, ჩაწერეთ კავშირის პარამეტრები თქვენი გარემოს ცვლადებში (Environment Variables / Secrets).
                </p>
              </div>
